...
namespace ThreadingTasks
{
    public partial class Task2Form : Form
    {
        ...
        {
            this.Text = "Задание 2: Копирование больших файлов";
        ...
        private void StartButton_Click(object? sender, EventArgs e)
        {
            ...
            Thread copyThread = new Thread(() => CopyFile(sourcePathTextBox.Text, destPathTextBox.Text, (int)threadCountNumeric.Value))
            {
                IsBackground = true
            };
            copyThread.Start();
        ...
        private void CopyFile(string sourcePath, string destPath, int threadCount)
        {
            try
            {
                ...
                long bytesPerThread = fileSize / threadCount;
